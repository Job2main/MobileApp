...
class MyJobsScreen extends StatefulWidget {
  ...
  MyJobsScreen({super.key}) {
    controller.createJob(1, 'Job 1', 'Description of job 1', 'Canada recipe', DateTime.now(), DateTime.now().add(const Duration(days: 2)), 22, 'Toronto', 'John Doe', "10:10", "15:00", status: CompanyJobStatus.comfirmed);
    controller.createJob(2, 'Job 2', 'Description of job 2', 'Canada recipe', DateTime.now(), DateTime.now().add(const Duration(days: 6)), 22, 'Toronto', 'John Doe', "10:10", "15:00", status: CompanyJobStatus.review);
    controller.createJob(3, 'Job 3', 'Description of job 3', 'Canada recipe', DateTime.now(), DateTime.now().add(const Duration(days: 9)), 22, 'Toronto', 'John Doe', "10:10", "15:00");
    controller.createJob(4, 'Job 4', 'Description of job 4', 'Canada recipe', DateTime.now(), DateTime.now().add(const Duration(days: 4)), 22, 'Toronto', 'John Doe', "10:10", "15:00");
  }
...
class _MyJobsScreenState extends State<MyJobsScreen> {
  ...
  Widget _getJobCard(Job job, BuildContext context) {
    return JobCard(
      ...
      // clickable: job.status != CompanyJobStatus.review,
    );
  }
